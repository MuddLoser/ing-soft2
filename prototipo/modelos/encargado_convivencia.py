"""
Modelo: EncargadoConvivencia (extiende Personal)
...
class EncargadoConvivencia(Personal):
    def __init__(self, nombre: str, rut: str, contacto: str, direccion: str):
        super().__init__(nombre, rut, contacto, direccion, rol="encargado_convivencia")
